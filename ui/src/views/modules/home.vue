...
<template>
  <el-card shadow="never" class="aui-card&#45;&#45;fill">
    &lt;!&ndash;<div class="mod-home">
      <h3>项目介绍</h3>
      <ul>
        <li>前端是基于vue、element-ui构建开发。</li>
        <li>后端是基于spring cloud + redis + rocketMQ + mysql构建开发。</li>
        <li>前后端分离，通过token进行数据交互，可独立部署</li>
        <li>动态菜单，通过菜单管理统一管理访问路由</li>
        <li>我的GitHub地址：<a href="https://github.com/Smartxiaowang/msproject" target="_blank">https://github.com/Smartxiaowang/msproject</a></li>
      </ul>
      <h3>项目目的</h3>
      <ul>
        <li>个人学习笔记</li>
    ...
    &lt;!&ndash;  <h3>我的微信</h3>
      <ul>
        <li><img src="public/vx.png" alt=""/></li>
      </ul>&ndash;&gt;
    </div>&ndash;&gt;
    <div class="mod-home">
     <span>
      ...
      _                    _          _ _ _<br>
      | |                  (_)        (_) | |<br>
      ____   ___    | | _  _   _  ____    _    _ _ _ _| | |<br>
      |  _ \ / _ \   | || \| | | |/ _  |  | |  | | | | | | |<br>
      | | | | |_| |  | |_) ) |_| ( ( | |  | |  | | | | | | |<br>
      |_| |_|\___/   |____/ \____|\_|| |  |_|   \____|_|_|_|<br>
      -       (_____|<br>
      | |<br>
      ___  ___    | | _   ____ ____  ____  _   _<br>
      /___)/ _ \   | || \ / _  |  _ \|  _ \| | | |<br>
      |___ | |_| |  | | | ( ( | | | | | | | | |_| |<br>
      (___/ \___/   |_| |_|\_||_| ||_/| ||_/ \__  |<br>
      |_|   |_|   (____/                     -&#45;&#45;&#45;&#45;SmartXiaoWang<br>
      ==============================================================<br>
     </span>
...
<template>
  <div class="dial">
    ...
    <div class="rotate">
      <!-- 转盘图片 -->
      <img class="dish" src="https://cache.yisu.com/upload/information/20220308/112/309407.jpg"/>
      <!-- 指针图片 -->
      <el-button @click="start">点我抽奖</el-button>
    </div>
